        ...
        Row(
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(
                    containerColor = AppColors.Button.EnableBackground,
                    contentColor = AppColors.Button.EnableContent,
                    disabledContainerColor = AppColors.Button.DisableBackground,
                    disabledContentColor = AppColors.Button.DisableContent
                ),
                shape = RoundedCornerShape(5.dp)
            ) {
                Text("Save Entry")
